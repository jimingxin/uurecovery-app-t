...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CXSwiftCommonModule/CXSwiftCommonModule.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JJCarouselView/JJCarouselView.framework"
