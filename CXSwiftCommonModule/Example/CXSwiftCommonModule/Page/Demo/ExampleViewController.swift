...
public class ExampleViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        if isFrom {
            self.cx.navigationBar?.title = "子页面"
//            cx.navigationBar?.rightImage = "common_icon_bg_color"
//            cx.navigationBar?.rightTitle = "右边"
        }
        self.view.backgroundColor = UIColor.init(red: 244.0 / 255.0, green: 245.0 / 255.0, blue: 245.0 / 255.0, alpha: 1.0)
//        cx.navigationBar?.title = self.title;
        ...
        tip.backgroundColor = UIColor.yellow;
        tip.cx.addTapGesture(target: self, action: #selector(ExampleViewController.homePageAction))
...
//        view.addSubview(icon)
    ...
    public override func viewDidLayoutSubviews() {
        ...
        tip.frame = self.view.bounds.insetBy(dx: 12, dy: Const.navBarHeight * 2)
