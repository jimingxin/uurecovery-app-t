...
public typealias AsyncsTask = () -> Void

public struct Asyncs {
    public static func async(_ task: @escaping AsyncsTask) {
        _async(task)
    }
    public static func async(_ task: @escaping AsyncsTask,
                             _ mainTask: @escaping AsyncsTask) {
        _async(task, mainTask)
    }
    private static func _async(_ task: @escaping AsyncsTask,
                               _ mainTask: AsyncsTask? = nil) {
    ...
    public static func delay(_ seconds: Double,
                             _ block: @escaping AsyncsTask) -> DispatchWorkItem {
    ...
    public static func asyncDelay(_ seconds: Double,
                                  _ task: @escaping AsyncsTask) -> DispatchWorkItem {
        return _asyncDelay(seconds, task)
    }
    
    @discardableResult
    public static func asyncDelay(_ seconds: Double,
                                  _ task: @escaping AsyncsTask,
                                  _ mainTask: @escaping AsyncsTask) -> DispatchWorkItem {
        return _asyncDelay(seconds, task, mainTask)
    }
    
    private static func _asyncDelay(_ seconds: Double,
                                    _ task: @escaping AsyncsTask,
                                    _ mainTask: AsyncsTask? = nil) -> DispatchWorkItem {
        let item = DispatchWorkItem(block: task)
